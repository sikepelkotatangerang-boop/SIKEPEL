...
export default function PreviewUmumPage() {
  ...
  const loadPreview = async (data: any) => {
    try {
      setIsLoading(true);
      const response = await fetch('/api/preview-umum-html', {
        method: 'POST',
        headers: {
  ...
  const handlePreviewPDF = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/preview-umum-pdf', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      // Call API to process Umum (convert to PDF with ConvertAPI, upload to Storage, save to DB)
      const response = await fetch('/api/process-umum', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      a.href = url;
      a.download = `Umum_${formData.nama_pemohon.replace(/\s+/g, '_')}_${Date.now()}.pdf`;
      ...
      alert(
        'Dokumen Surat Keterangan Umum berhasil dibuat!\n\n' +
        '✓ PDF telah diunduh\n' +
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Preview Dokumen Surat Keterangan Umum</h1>
              ...
              <>
                ...
                <div className="preview-container">
                  <iframe
                    ...
                    title="Preview Surat Keterangan Umum"
                  />
                </div>
              </>
            )}
