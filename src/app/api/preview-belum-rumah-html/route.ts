...
/**
 * API untuk generate preview HTML dari Surat Keterangan Belum Memiliki Rumah
 */
...
<head>
  ...
  <title>Preview Surat Keterangan Belum Memiliki Rumah - ${data.nama_pemohon}</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="preview-container">
    ...
    <div class="content">
      ...
      <p>Berdasarkan ${data.pengantar_rt ? `Surat Pengantar RT ${data.pengantar_rt}` : 'keterangan yang ada'}, bahwa nama tersebut di atas adalah benar warga Kelurahan ${data.kelurahan} dan <strong>sampai saat ini belum memiliki rumah/tempat tinggal sendiri</strong>.</p>
